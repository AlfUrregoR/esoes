    ...
    <form id="contact-form" name="contact-form" action="<?php echo get_permalink(); ?>#contact-form" method="post">
      ...
      <div class="fondo">
        <div class="row">
          <div class="col-sm-12 col-md-6">
            <div class="form-group group-izq field-container">
              <label for="f_name" class="floating-label"><?php the_field('name'); ?></label>
              <input type="text" id="f_name" name="f_name" class="form-control field" value="<?php echo $f_name; ?>" placeholder="<?php the_field('name'); ?>" required aria-required="true">
          ...
          <div class="col-sm-12 col-md-6">
            <div class="form-group group-der field-container">
              <label for="f_email" class="floating-label"><?php the_field('email'); ?></label>
              <input type="email" id="f_email" name="f_email" class="form-control field" value="<?php echo $f_email; ?>" placeholder="<?php the_field('email'); ?>" required aria-required="true">
        ...
        <div class="row">
          <div class="col-sm-12 col-md-6">
            <div class="form-group group-izq field-container">
              <label for="f_phone" class="floating-label"><?php the_field('phone'); ?></label>
              <input type="tel" id="f_phone" name="f_phone" class="form-control field" value="<?php echo $f_phone; ?>" placeholder="<?php the_field('phone'); ?>">
          ...
          <div class="col-sm-12 col-md-6">
            <div class="form-group group-der field-container">
              <label for="f_site" class="floating-label"><?php the_field('web_site'); ?></label>
              <input type="text" id="f_site" name="f_site" class="form-control field" value="<?php echo $f_site; ?>" placeholder="<?php the_field('web_site'); ?>" required aria-required="true">
        ...
        <div class="row">
          <div class="col-sm-12 col-md-6">
            <div class="form-group group-izq field-container">
              <label for="f_sujet" class="floating-label"><?php the_field('subject'); ?></label>
              <input type="text" id="f_sujet" name="f_sujet" class="form-control field" value="<?php echo $f_sujet; ?>" placeholder="<?php the_field('subject'); ?>">
          ...
          <div class="col-sm-12 col-md-6">
            <div class="form-group group-der field-container">
              <label for="f_pays" class="floating-label"><?php the_field('country'); ?></label>
              <input type="text" id="f_pays" name="f_pays" class="form-control field" value="<?php echo $f_pays; ?>" placeholder="<?php the_field('country'); ?>" required aria-required="true">
        ...
        <div class="row">
          <div class="col-sm-12 col-md-12 div-message">
            <div class="form-group">
              <label for="f_message"><?php the_field('message'); ?></span></label>
